...
class Client(Iface):
    ...
    def missingBlocks(self, hashes):
        ...
        Parameters:
         - hashes
        """
        self.send_missingBlocks(hashes)
        return self.recv_missingBlocks()

    def send_missingBlocks(self, hashes):
        self._oprot.writeMessageBegin('missingBlocks', TMessageType.CALL, self._seqid)
        args = missingBlocks_args()
        args.hashes = hashes
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_missingBlocks(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = missingBlocks_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "missingBlocks failed: unknown result")
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["missingBlocks"] = Processor.process_missingBlocks
    ...
    def process_storeBlock(self, seqid, iprot, oprot):
        ...
        oprot.writeMessageBegin("storeBlock", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
    ...
    def process_deleteBlock(self, seqid, iprot, oprot):
        ...
        try:
            ...
            logging.exception(ex)
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("deleteBlock", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_missingBlocks(self, seqid, iprot, oprot):
        args = missingBlocks_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = missingBlocks_result()
        try:
            result.success = self._handler.missingBlocks(args.hashes)
            msg_type = TMessageType.REPLY
        except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
            raise
        except Exception as ex:
            ...
            logging.exception(ex)
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("missingBlocks", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class storeBlock_result(object):
    """
    Attributes:
     - success
    """
...
class deleteBlock_result(object):
    """
    Attributes:
     - success
    """
...
class missingBlocks_args(object):
    """
    Attributes:
     - hashes
    """
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.LIST, 'hashes', (TType.STRING, 'UTF8', False), None, ),  # 1
    )
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, (self.__class__, self.thrift_spec)))
            return
        oprot.writeStructBegin('missingBlocks_args')
        if self.hashes is not None:
            oprot.writeFieldBegin('hashes', TType.LIST, 1)
            oprot.writeListBegin(TType.STRING, len(self.hashes))
            for iter13 in self.hashes:
...
class missingBlocks_result(object):
    """
    Attributes:
     - success
    """
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, (self.__class__, self.thrift_spec)))
            return
        oprot.writeStructBegin('missingBlocks_result')
        if self.success is not None:
